...
class Router:
    ...
    def help(self):
        return """
        <body>
        <a href="http://localhost:5000/add/testing/120"><p>Add task</p>
        <a href="http://localhost:5000/update/testing"><p>Update task</p>
        <a href="http://localhost:5000/"><p>Check Status</p>
        </body>
        """